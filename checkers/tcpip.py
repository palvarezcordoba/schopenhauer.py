...
class TCPIP:
	...
	def rpFilter(self):
		...
		or not int(self.sysctl.read("net.ipv4.conf.all.rp_filter")):
			log.error("Enable net.ipv4.conf.default.rp_filter and net.ipv4.conf.all.rp_filter.")
	...
	def logMartianPackets(self):
		...
		or not int(self.sysctl.read("net.ipv4.conf.all.log_martians")):
			log.error("Enable net.ipv4.conf.default.log_martians and net.ipv4.conf.all.log_martians.")
